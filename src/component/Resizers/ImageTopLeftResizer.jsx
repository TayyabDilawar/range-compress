...
const ImageTopLeftResizer = (props) => {
    ...
    const resizerMouseMove = (e) => {
        ...
        props.changeImageWindowWidthHeight(newImageWidth, newImageHeight, newXPosition, newYPosition,props.limitFromTopBottom,props.limitFromLeftRight)
        e.preventDefault();
    }
...
export default connect(null, mapDispatchToProps)(ImageTopLeftResizer);