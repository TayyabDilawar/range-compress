...
const ImageTopRightResizer = (props) => {
    ...
    const resizerMouseMove = (e) => {
        ...
        const change_in_position_y = newYPosition - props.yPosition;
        ...
        props.changeImageWindowWidthHeight(newImageWidth, newImageHeight, props.xPosition, newYPosition, props.limitFromTopBottom, props.limitFromLeftRight)
        e.preventDefault();
    }
...
export default connect(null, mapDispatchToProps)(ImageTopRightResizer);